...
const SliderContent = () => {
  return (
    <Flex gap="0px" className='sliderContainer2' flex='none' align='center'>
      {list.map((i, index) => (
        <div key={index} >
          <img src={i.url} alt={i.title} style={{width:'120px',height:'40px',objectFit:'contain',marginLeft:'20px'}} />
          {/*<Image src={i.url} preview={false}/>*/}
        </div>
      ))}
    </Flex>
  )
